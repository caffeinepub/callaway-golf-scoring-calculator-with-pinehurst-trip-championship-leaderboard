...
export class Backend implements backendInterface {
    ...
    async submitEvent(arg0: GolferId, arg1: bigint, arg2: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEvent(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEvent(arg0: GolferId, arg1: Array<bigint>): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_EventResult]): EventResult | null {
